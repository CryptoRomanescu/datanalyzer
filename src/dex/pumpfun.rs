...
mod tests {
    ...
    fn create_mock_account_data(token_reserve: u64, sol_reserve: u64) -> Vec<u8> {
        ...
        data[PumpFunDecoder::REAL_TOKEN_RESERVES_OFFSET
            ..PumpFunDecoder::REAL_TOKEN_RESERVES_OFFSET + 8]
            .copy_from_slice(&token_reserve.to_le_bytes());

        // Set real SOL reserves at offset 0x20
        data[PumpFunDecoder::REAL_SOL_RESERVES_OFFSET
            ..PumpFunDecoder::REAL_SOL_RESERVES_OFFSET + 8]
